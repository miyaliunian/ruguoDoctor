...
export default class NewsSearchList extends Component {
    ...
    fetchData() {
        ...
        let uri = 'http://rap2api.taobao.org/app/mock/1368/GET/newsList';
        ...
        return (
            <TouchableOpacity onPress={() => this.showDetail(rowData.item.id)}>
                <View style={styles.rowCenter} key={rowData.item.id}>
                    {rowData.item.newsMainPicUrl ?
                        <Image source={{uri: rowData.item.newsMainPicUrl}}
                    ...
                    <View style={styles.newsContent}>
                        <View>
                            <View style={{flexDirection: 'row'}}>
                                <Text style={styles.newsTitle}>{rowData.item.newsTitle}</Text>
                                {/*<Text style={styles.newsTitleSub}>*/}
                                {/*{good.goodsTitle === '' || good.goodsTitle == null ? '' : '(' + good.goodsTitle + ')'}*/}
                                {/*</Text>*/}
                            </View>
                            <View style={styles.newsContentLine2}>
                                <Text style={styles.newsDescribe} numberOfLines={2}>{rowData.item.newsDescribe}</Text>
                            </View>
                        </View>
                        <View style={styles.newsContentLine3}>
                            <Text style={styles.newsKeyword}>{rowData.item.newsKeyword}</Text>
