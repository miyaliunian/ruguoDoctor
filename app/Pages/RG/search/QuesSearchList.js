...
export default class QuesSearchList extends Component {
    ...
    fetchData() {
        ...
        let uri = 'http://rap2api.taobao.org/app/mock/1368/GET/quesList';
    ...
    renderRow(rowData) {
        return (
            <TouchableOpacity onPress={() => this.showDetail(rowData.item.id)}>
                <View style={[styles.queRow]} key={rowData.item.id}>
                    <View style={styles.rowLeft}>
                        <Text style={styles.queFontLabel}>{rowData.item.quesTitle}</Text>
                    </View>
