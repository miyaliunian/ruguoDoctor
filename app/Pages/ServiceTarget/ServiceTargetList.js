...
export default class ServiceTargetList extends Component {
    constructor(props) {
        super(props);
    ...
    fetchData() {
        ...
        let uri = Config.BASE_URL + Config.API_SERVICE_TARGET_LIST;
        // let uri = 'http://rap2api.taobao.org/app/mock/1368/GET/goodslist';
        let param = {
            personnelCode: this.memberCode,
            ...
            <View key={rowData.item.id}>
                <TouchableOpacity onPress={() => this.showDetail(rowData.item)}>
                    <View style={styles.rowCenter}>
                        {rowData.item.relaPerPicUrl ?
                            <Image source={{uri: rowData.item.relaPerPicUrl}}
                        ...
                        <View style={styles.productContent}>
                            <View>
                                <View style={{flexDirection: 'row'}}>
                                    <Text style={styles.productTitle}>{rowData.item.relaPerName}</Text>
                                    <Text style={styles.productTitleSub}>
                                        {/*({rowData.item.senderGenderName})*/}
                                        {rowData.item.relaPerGenderName === '' || rowData.item.relaPerGenderName == null ? '' : '(' + rowData.item.relaPerGenderName + ')'}
                                    </Text>
                                </View>
                            ...
                            <View style={styles.productContentLine3}>
                                <Text style={styles.productPriceTotal}>{rowData.item.relaPerBirthday}</Text>
    ...
    showDetail = (item) => {
        ...
        navigation.navigate(menu, {
            senderName: item.relaPerName,
            senderCode: item.personnelRelaCode,
