...
export default class OrderHaveComplete extends Component {
            ...
            <View style={[{}, this.state.keyboardShown && styles.bumpedContainer,GlobalStyles.root_container]}>
                ...
                <ScrollView style={{flex: 1}}>
                    <View style={{height:Px2dp.getHeight(100),backgroundColor:'rgb(255,208,96)',
                        ...
                        <Text style={{fontSize:18,color:'rgb(255,255,255)'}}>已完成</Text>
                    </View>
                    ...
                    <View style={{ backgroundColor:'rgb(255,255,255)',
                        ...
                        <View style={{backgroundColor:'rgb(255,255,255)',flexDirection:'row',
                            ...
                            <View style={{flexDirection:'row',justifyContent:'flex-end',
                                ...
                                <TouchableOpacity onPress={() => this.deleteService()}>
                                    <View style={styles.ButtonDelStyle}>
                                        <Text style={[styles.fontDeleteLabel]}>删除订单</Text>
                                    </View>
                                </TouchableOpacity>
                                {this.fontState()}
                            </View>
               ...
               <ConfirmModal visible={this.state.modalVisible} confirmTitle='确实要删除该订单吗？'
                             transparent={true} onRequestCancle={()=>this.cancleDeleteService()}
                             onRequestConfirm={()=>this.cancleDeleteService()}
                             onRequestClose={()=>this.requestClose()}
                             confirmBtnTitle='确定' cancleBtnTitle='取消'
               />
                {/*加载Model弹出层   */}
