...
export default class OrderToBePay extends Component {
            ...
            <View style={[{}, this.state.keyboardShown && styles.bumpedContainer,GlobalStyles.root_container]}>
                ...
                <ScrollView style={{flex: 1}}>
                    <View style={{height:Px2dp.getHeight(100),backgroundColor:'rgb(255,208,96)',
                        ...
                        <Text style={{fontSize:18,color:'rgb(239,94,82)'}}>待支付</Text>
                    </View>
                            ...
                            <View style={{flexDirection:'row',justifyContent:'flex-end',
                                ...
                                <TouchableOpacity onPress={() => this.purchaseService()}>
                                    <View style={styles.ButtonStyle1}>
                                        <Text style={[styles.fontLabel]}>取消订单</Text>
                                    </View>
                                </TouchableOpacity>
    ...
    onClick(tag){
        ...
        // 跳转到支付页面
        navigate(tag, {go_back_key: state.key,title:'支付',ActualPayment:this.state.ActualPayment})
    }

    submitGoToPay(){
        this.onClick(MoreMenu.Profile.pay.menu_pay)
        // if(this.state.isEnd){
        //     DeviceEventEmitter.emit('toastInfo', '支付时间已结束', 'fail');
        //     return;
        // }else{
        //     DeviceEventEmitter.emit('toastInfo', '付款成功', 'success');
        // }
    }
    //f付款时间结束更改状态
    isEndFlag(isEnd){
