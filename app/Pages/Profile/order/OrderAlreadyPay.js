...
export default class OrderAlreadyPay extends Component {
            ...
            <View style={[{}, this.state.keyboardShown && styles.bumpedContainer,GlobalStyles.root_container]}>
                ...
                <ScrollView style={{flex: 1}}>
                    <View style={{height:Px2dp.getHeight(100),backgroundColor:'rgb(255,208,96)',
                        ...
                        <Text style={{fontSize:18,color:'#ffffff'}}>已支付</Text>
                    </View>
                    ...
                    <View style={{ backgroundColor:'rgb(255,255,255)',
                        ...
                        <View style={{backgroundColor:'rgb(255,255,255)',flexDirection:'row',
                            ...
                            <View style={{flexDirection:'column',alignItems:'center',justifyContent:'center',
                                ...
                                {/*<Text style={{fontSize:14,color:'rgb(51,51,51)'}}>付款剩余时间</Text>*/}
                                {/*<View style={{alignItems:'center'}}>*/}
                                {/*<CountDown*/}
                                {/*// date={new Date(parseInt('3000'))}*/}
                                {/*date="2017-12-15T16:50:00+08:00"*/}
                                {/*days={{plural: 'Days',singular: 'day'}}*/}
                                {/*hours=':'*/}
                                {/*mins=':'*/}
                                {/*segs='0'*/}
                                {/*onEnd={()=>{this.isEndFlag(this.state.isEnd)}}*/}

                                {/*daysStyle={{backgroundColor:'rgb(255,255,255)'}}*/}
                                {/*hoursStyle={{backgroundColor:'rgb(255,255,255)'}}*/}
                                {/*minsStyle={{backgroundColor:'rgb(255,255,255)'}}*/}
                                {/*secsStyle={{backgroundColor:'rgb(255,255,255)'}}*/}
                                {/*firstColonStyle={{}}*/}
                                {/*secondColonStyle={{}}*/}
                                {/*/>*/}
                                {/*</View>*/}
                            ...
                            <View style={{flexDirection:'row',justifyContent:'flex-end',
                                ...
                                <TouchableOpacity onPress={() => this.purchaseService()}>
                                    <View style={styles.ButtonStyle1}>
                                        <Text style={[styles.fontLabel]}>申请退款</Text>
                                    </View>
                                </TouchableOpacity>
    ...
    fontState() {
        if(this.state.goodsType=='0'){
            return (
                <TouchableOpacity onPress={() => this.implementOrder()}>
                    <View style={styles.ButtonStyle2}>
                        <Text style={[styles.fontLabel1]}>执行订单</Text>
                    </View>
                </TouchableOpacity>
            )
        }else if(this.state.goodsType=='1'){
            return (
                <TouchableOpacity onPress={() => this.seeLogistics()}>
                    <View style={styles.ButtonStyle2}>
                        <Text style={[styles.fontLabel1]}>查看物流</Text>
                    </View>
                </TouchableOpacity>
            )
        }else if(this.state.goodsType=='2'){
            return (
                <View></View>
            )
        }
    ...
    //执行订单
    implementOrder(){
        DeviceEventEmitter.emit('toastInfo', '执行订单', 'success');
    }
    //查看物流
    seeLogistics(){
        DeviceEventEmitter.emit('toastInfo', '查看物流', 'success');
    }
    //f付款时间结束更改状态
    isEndFlag(isEnd){
                    ...
                    <View key={i}>
                        <View style={[styles.cellContainer]}>
                            <View style={{flexDirection: 'row', alignItems: 'center',}}>
                                <Image style={styles.imageStyle} source={{uri: data.goodsIconUrl}}/>
                            </View>
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            //购买的商品信息集合
            goodsList:[{id:'1',goodsUintNum:'2',goodsName:"牛板筋",goodsPrice:"299",goodsTitle:'黄老板独家秘制 小包装牛筋 麻辣味牛板筋125g/袋。',goodsIconUrl:'http:////img10.360buyimg.com/n7/jfs/t16243/132/42795260/438474/affa3631/5a262cb7N67a23ebf.jpg'},
                {id:'2',goodsUintNum:'2',goodsName:"黄氏拌饭",goodsPrice:"99",goodsTitle:'황 씨 비빔밥, 백 년 정선, 최적 원료 제작, 맛있는 만만하다。',goodsIconUrl:'http:////img12.360buyimg.com/n7/jfs/t3076/55/3503449239/312803/c5ba0686/57f4a1d2N88ec78ab.jpg'},
                {id:'3',goodsUintNum:'1',goodsName:"大瓜",goodsPrice:"997",goodsTitle:'黄老板菜地出品，不甜不要钱。',goodsIconUrl:'http://img10.360buyimg.com/n4/s130x130_jfs/t10945/175/2172045473/162582/5bf301ef/59f05afdN3c13f6ed.jpg'}],
