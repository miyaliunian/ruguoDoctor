...
export default class NavigationBar extends Component {
    ...
    static propTypes = {
        ...
        statusBar:PropTypes.shape(StatueBarShape)
    };
...
const styles = StyleSheet.create({
    ...
    status:{
        height:Platform.OS === 'ios' ? STATUS_BAR_HEIGHT_IOS:STATUS_BAR_HEIGHT_ANDROID
    }
});
